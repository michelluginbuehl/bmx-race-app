...
const APP_CHANGE_NOTE = "Header-Kachel nochmals höher und dynamisch angepasst, damit das Banner-Logo vollständig sichtbar ist";
...
Vor dem Löschen wird automatisch ein komplettes Backup erstellt.`,
  ...
  const renderAppHeader = () => (
    <button
      ...
      style={{
        width: "100%",
        minHeight: "clamp(190px, 18.5vw, 248px)",
        display: "flex",
        alignItems: "flex-end",
