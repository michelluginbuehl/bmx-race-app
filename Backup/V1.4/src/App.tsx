      ...
      >
        ...
        <div style={{ ...basePanelStyle, marginBottom: 14 }}>
          ...
          >
            <button
              ...
              style={{ ...compactHomeHighlightButtonStyle, flex: "0 0 128px", minHeight: 64, display: "inline-flex", alignItems: "center", justifyContent: "center" }}
            >
              Teilnehmer erfassen
            </button>
            {RACES.map((race) => (
            ...
            <button
              ...
              style={{ ...compactPrimaryButtonStyle, marginLeft: "auto", flex: "0 0 128px", minHeight: 64, display: "inline-flex", alignItems: "center", justifyContent: "center" }}
            >
              Gesamtwertung
            </button>
          </div>
        ...
        <div style={{ ...basePanelStyle, marginBottom: 14 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            ...
            <button onClick={exportBackup} style={compactPrimaryButtonStyle}>
              Backup exportieren
            </button>
      ...
      >
        ...
        <div style={{ ...basePanelStyle, marginBottom: 20 }}>
          ...
          >
            ...
            <button onClick={() => setViewMode("overall")} style={compactPrimaryButtonStyle}>
              Gesamtwertung
            </button>
          </div>
        </div>
